...
# roshanbhatia.com/kubernetes-operator-dgraph-bundle:$VERSION and roshanbhatia.com/kubernetes-operator-dgraph-catalog:$VERSION.
IMAGE_TAG_BASE ?= roshanbhatia.com/kubernetes-operator-dgraph
